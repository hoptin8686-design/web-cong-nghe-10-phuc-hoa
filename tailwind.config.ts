...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        void: "#0A1720", // Nền trang vũ trụ nông nghiệp
        "void-card": "#102631", // Nền khối hộp/thẻ bài học
        "void-light": "#183745", // Viền và trạng thái hover
        sea: "#0D7C86", // Nút bấm & thương hiệu chính
        "sea-deep": "#5EEAD4", // Chữ nổi bật trên nền tối
        coral: "#F2683C", // Màu nhấn cam san hô
        "coral-deep": "#FDBA74", // Chữ cam sáng
        leaf: "#0E9F6E", // Đáp án đúng / màu xanh cây trồng
        "leaf-deep": "#6EE7B7", // Chữ xanh lá sáng
        gold: "#EFA31D", // Sao thưởng ⭐ / thành tích
        "gold-deep": "#FCD34D", // Chữ vàng sáng
        berry: "#DC2626", // Đáp án sai / cảnh báo
      ...
      boxShadow: {
        ...
        "glow-leaf": "0 0 20px rgba(14,159,110,0.35)",
      },
      keyframes: {
        "pop-in": {
