        ...
        <div className="mx-auto max-w-3xl">
          <div className="text-center">
            ...
            <p className="mx-auto mt-2 max-w-lg text-sm text-star-soft">
              Hệ thống đề kiểm tra Giữa kì & Cuối kì bám sát kế hoạch giáo dục
              Trường THPT Phục Hòa (Cao Bằng), giúp học sinh tự tin đạt điểm cao.
            </p>
          </div>
          ...
          <div className="mt-8 space-y-4">
            {MOCK_EXAMS.map((exam) => (
              <div
                key={exam.id}
                className="flex flex-col gap-4 rounded-2xl border border-star/15 bg-void-card p-6 shadow-card transition hover:border-leaf/50 sm:flex-row sm:items-center sm:justify-between"
              >
                <div>
                  <span className="rounded-full bg-leaf/15 px-3 py-1 font-mono text-xs font-bold text-leaf-deep">
                    Đề kiểm tra định kỳ
                  </span>
                  ...
                  <p className="mt-2 font-mono text-xs text-leaf-deep">
                    📝 {exam.questions.length} câu trắc nghiệm · ⏱️ {exam.durationMinutes} phút làm bài
                  </p>
                </div>
                <button
                  onClick={() => handleStartExam(exam)}
                  className="shrink-0 rounded-full bg-gradient-to-r from-leaf to-sea px-6 py-2.5 font-display text-sm font-bold text-void shadow-card hover:shadow-glow-leaf transition font-extrabold"
                >
                  Bắt đầu làm bài →
                </button>
              </div>
          ...
          <div className="mt-6 animate-pop-in rounded-2xl border border-star/15 bg-void-card p-6 text-center shadow-card">
            ...
            <div className="mt-4 flex justify-center gap-3">
              <button
                ...
                className="rounded-full bg-leaf px-5 py-2 font-display text-xs font-bold text-void hover:opacity-90 transition font-extrabold"
              >
                🔄 Làm lại đề này
              </button>
              <button
        ...
        {!submitted && (
          <div className="mt-8 flex justify-center pb-12">
            <button
              ...
              className="rounded-full bg-gradient-to-r from-leaf to-sea px-8 py-3.5 font-display text-base font-extrabold text-void shadow-card hover:shadow-glow-leaf transition hover:-translate-y-0.5"
            >
