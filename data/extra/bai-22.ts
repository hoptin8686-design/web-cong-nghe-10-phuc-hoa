...
// Ngân hàng câu hỏi Đúng/Sai và Tự luận: Bài 22. Dự án trồng hoa trong chậu
export const EXTRA_BAI_22: LessonExtra = {
  tf: [
    {
      id: "tf-01",
      context: "Khi nghiên cứu và thực hành kiến thức của Bài 22. Dự án trồng hoa trong chậu:",
      statements: [
        {
  ...
  essay: [
    ...
    {
        "q": "Liên hệ thực tế địa phương tại Cao Bằng đối với việc ứng dụng kiến thức của Bài 22. Dự án trồng hoa trong chậu.",
