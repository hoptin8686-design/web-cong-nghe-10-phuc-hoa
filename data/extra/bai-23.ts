...
// Ngân hàng câu hỏi Đúng/Sai và Tự luận: Bài 23. Giới thiệu về trồng trọt công nghệ cao
export const EXTRA_BAI_23: LessonExtra = {
  tf: [
    {
      id: "tf-01",
      context: "Khi nghiên cứu và thực hành kiến thức của Bài 23. Giới thiệu về trồng trọt công nghệ cao:",
      statements: [
        {
  ...
  essay: [
    ...
    {
        "q": "Liên hệ thực tế địa phương tại Cao Bằng đối với việc ứng dụng kiến thức của Bài 23. Giới thiệu về trồng trọt công nghệ cao.",
