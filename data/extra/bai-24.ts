...
// Ngân hàng câu hỏi Đúng/Sai và Tự luận: Bài 24. Một số công nghệ cao trong trồng trọt
export const EXTRA_BAI_24: LessonExtra = {
  tf: [
    {
      id: "tf-01",
      context: "Khi nghiên cứu và thực hành kiến thức của Bài 24. Một số công nghệ cao trong trồng trọt:",
      statements: [
        {
  ...
  essay: [
    ...
    {
        "q": "Liên hệ thực tế địa phương tại Cao Bằng đối với việc ứng dụng kiến thức của Bài 24. Một số công nghệ cao trong trồng trọt.",
