...
// Ngân hàng câu hỏi Đúng/Sai và Tự luận: Bài 17. Một số bệnh hại cây trồng thường gặp và biện pháp phòng trừ
export const EXTRA_BAI_17: LessonExtra = {
  tf: [
    {
      id: "tf-01",
      context: "Khi nghiên cứu và thực hành kiến thức của Bài 17. Một số bệnh hại cây trồng thường gặp và biện pháp phòng trừ:",
      statements: [
        {
  ...
  essay: [
    ...
    {
        "q": "Liên hệ thực tế địa phương tại Cao Bằng đối với việc ứng dụng kiến thức của Bài 17. Một số bệnh hại cây trồng thường gặp và biện pháp phòng trừ.",
