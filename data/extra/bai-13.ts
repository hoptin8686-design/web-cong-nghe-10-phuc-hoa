...
// Ngân hàng câu hỏi Đúng/Sai và Tự luận: Bài 13. Nhân giống cây trồng
export const EXTRA_BAI_13: LessonExtra = {
  tf: [
    {
      id: "tf-01",
      context: "Khi nghiên cứu và thực hành kiến thức của Bài 13. Nhân giống cây trồng:",
      statements: [
        {
  ...
  essay: [
    ...
    {
        "q": "Liên hệ thực tế địa phương tại Cao Bằng đối với việc ứng dụng kiến thức của Bài 13. Nhân giống cây trồng.",
