...
// Ngân hàng câu hỏi Đúng/Sai và Tự luận: Bài 9. Sử dụng công nghệ vi sinh trong sản xuất phân bón
export const EXTRA_BAI_09: LessonExtra = {
  tf: [
    {
      id: "tf-01",
      context: "Khi nghiên cứu và thực hành kiến thức của Bài 9. Sử dụng công nghệ vi sinh trong sản xuất phân bón:",
      statements: [
        {
  ...
  essay: [
    ...
    {
        "q": "Liên hệ thực tế địa phương tại Cao Bằng đối với việc ứng dụng kiến thức của Bài 9. Sử dụng công nghệ vi sinh trong sản xuất phân bón.",
