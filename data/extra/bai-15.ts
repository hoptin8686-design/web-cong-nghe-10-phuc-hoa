...
// Ngân hàng câu hỏi Đúng/Sai và Tự luận: Bài 15. Sâu, bệnh hại cây trồng và ý nghĩa của việc phòng trừ
export const EXTRA_BAI_15: LessonExtra = {
  tf: [
    {
      id: "tf-01",
      context: "Khi nghiên cứu và thực hành kiến thức của Bài 15. Sâu, bệnh hại cây trồng và ý nghĩa của việc phòng trừ:",
      statements: [
        {
  ...
  essay: [
    ...
    {
        "q": "Liên hệ thực tế địa phương tại Cao Bằng đối với việc ứng dụng kiến thức của Bài 15. Sâu, bệnh hại cây trồng và ý nghĩa của việc phòng trừ.",
