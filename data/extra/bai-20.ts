...
// Ngân hàng câu hỏi Đúng/Sai và Tự luận: Bài 20. Công nghệ cao trong thu hoạch và bảo quản sản phẩm trồng trọt
export const EXTRA_BAI_20: LessonExtra = {
  tf: [
    {
      id: "tf-01",
      context: "Khi nghiên cứu và thực hành kiến thức của Bài 20. Công nghệ cao trong thu hoạch và bảo quản sản phẩm trồng trọt:",
      statements: [
        {
  ...
  essay: [
    ...
    {
        "q": "Liên hệ thực tế địa phương tại Cao Bằng đối với việc ứng dụng kiến thức của Bài 20. Công nghệ cao trong thu hoạch và bảo quản sản phẩm trồng trọt.",
